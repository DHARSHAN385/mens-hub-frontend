    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <section className="mb-8 border-b pb-6 border-neutral-200 dark:border-neutral-800">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
          Your payment information is securely processed using standard SSL encryption via secure payment gateway, and we never store your credit/debit card numbers or net banking credentials on our servers. Your information is never sold or shared with external third parties for marketing purposes.
        </p>
      </section>
